...
class AdminMasterTimeApi extends BaseApi
{
    protected $modelName = TimeModel::class;
    public function index()
    {
        $times = $this->model->select("ROW_NUMBER() OVER (ORDER BY time_name) AS no,times.*")->findAll();
        return $this->respond([
            'status' => '00',
